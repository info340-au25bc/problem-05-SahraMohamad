...
const motto = 'The iSchool is my school';
...
const hasCool = motto.includes('cool');
console.log(hasCool);
...
const expandedMotto = motto.replace('iSchool', 'Information School');
...
const ratioPct = ((expandedMotto.length / mottoLength) * 100).toFixed(2) + '%';
...
//Log out the circle
const circle = { cx: 34, cy: 43, radius: sorted[sorted.length - 1] };
console.log(circle);
...
const triangle = { base: 33, height: 44 };
